...
public class StudentEventRegistrationSystem {
    public static void main(String[] args) {
        ...
        event.register(new Participant<>(1, "Yash", "CSE"));
        event.register(new Participant<>(2, "Aditya", "ECE"));
        event.register(new Participant<>(3, "Yash", "CSE"));
        event.register(new Participant<>(4, "Bob", "EEE"));
